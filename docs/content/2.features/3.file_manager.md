...
Click on any file to open it in the built-in editor. MCDash supports syntax highlighting for many file types including:
...
MCDash supports uploading large files by splitting them into chunks, so you can upload plugins, mods, or world backups without issues.

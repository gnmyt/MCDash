package de.gnm.voxeldash.manager;
...
public class WhitelistManager {
    ...
    public WhitelistManager(VoxelDashBungee plugin) {
        instance = this;
    ...
    public void load() {
        ...
        try {
            ...
            VoxelDashBungee.getInstance().getLogger().log(Level.SEVERE, "Failed to load whitelist", e);
        }
    }
    ...
    public synchronized void save() {
        try {
            ...
            VoxelDashBungee.getInstance().getLogger().log(Level.SEVERE, "Failed to save whitelist", e);
        }
    }

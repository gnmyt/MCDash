...
public class BanManager {
    ...
    public BanManager(VoxelDashBungee plugin) {
        instance = this;
    ...
    public void load() {
        ...
        try {
            ...
            VoxelDashBungee.getInstance().getLogger().log(Level.SEVERE, "Failed to load bans", e);
        }
    }
    ...
    public synchronized void save() {
        try {
            ...
            VoxelDashBungee.getInstance().getLogger().log(Level.SEVERE, "Failed to save bans", e);
        }
    }

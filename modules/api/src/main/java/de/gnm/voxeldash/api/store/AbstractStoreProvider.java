...
public abstract class AbstractStoreProvider implements StoreProvider {
    ...
    protected static final String USER_AGENT = "VoxelDash/1.0 (https://github.com/gnmyt/VoxelDash)";
    ...
    protected AbstractStoreProvider() {
        this.tempDownloadDir = new File(System.getProperty("java.io.tmpdir"), "voxeldash-downloads");

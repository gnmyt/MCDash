...
public class SSHShell implements Command {
    ...
    /**
     * Executes the given command, append the command to the command buffer and send the command to the server
     */
    ...
    private void sendLogLines() {
        try {
            while (true) {
                String[] lines = {"TODO"}; // TODO: Implement proper event logging once the event system is implemented
    ...
    private void executeCommand(String commandString) {
        // TODO: Pipe the command to the server
    }
